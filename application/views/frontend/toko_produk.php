                    ...
                    <table class="table table-striped">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                          <img src="<?php echo base_url('assets/upload_produk/'.$value->foto) ?>" style="object-fit: contain" alt="logo-toko-<?php echo $value->namaProduk?>" width="75" height="75"> 
                          </td>
                          <td><?php echo $value->stok ?></td>
                          
                          <td>
                            <a href="<?php echo site_url('/toko/delete_produk/'.$value->idProduk);?>" class="btn btn-danger" onClick="return confirm('Are you sure for make this change?')">Delete</a>
