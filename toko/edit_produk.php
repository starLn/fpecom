<section class="section">
          ...
          <div class="section-body">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
			          <form id="setting-form" method="post" enctype="multipart/form-data" action="<?php echo base_url('toko/update_produk');?>">
                      <input type="number" name="idProduk" value="<?php echo $produk->idProduk ?>" hidden required>
                      <input type="number" name="idToko" value="<?php echo $toko->idToko ?>" hidden required>
                  ...
                  <div class="card" id="settings-card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9">
                          <textarea class="form-control" name="deskripsiProduk" id="site-description" required><?php echo $produk->deskripsiProduk ?></textarea>
                        </div>
                      </div>
                      <div class="form-group row align-items-center">
