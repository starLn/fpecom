<section class="section">
          ...
          <div class="section-body">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
			          <form id="setting-form" method="post" enctype="multipart/form-data" action="<?php echo base_url('toko/store_produk');?>">
                  ...
                  <div class="card" id="settings-card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9">
                          <textarea class="form-control" name="deskripsiProduk" id="site-description" required></textarea>
                        </div>
                      </div>
                      <div class="form-group row align-items-center">
