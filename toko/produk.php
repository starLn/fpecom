                ...
                <div class="card mb-0">
                  <div class="card-body">
                    <ul class="nav nav-pills">
                      <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url('toko/create_produk/'.$toko->idToko);?>">Silakan Membuat Produk</a>
                      </li>
                    ...
                    <table class="table table-striped">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url('/toko/detail_produk/'.$value->idProduk); ?>" class="btn btn-info">Detail</a>
                            <a href="<?php echo base_url('/toko/edit_produk/'.$value->idProduk); ?>" class="btn btn-primary">Edit</a>
                          </td>
                        </tr>
                      <?php
                      } ?>
